...
/**
 * @covers \Ergebnis\PhpCsFixer\Config\RuleSet\Php84
 *
 ...
 * @no-named-arguments
 */
final class Php84Test extends ExplicitRuleSetTestCase
{
    protected static function createRuleSet(): RuleSet
    {
        return RuleSet\Php84::create();
    }
    ...
    {
        return Name::fromString('ergebnis (PHP 8.4)');
    }
